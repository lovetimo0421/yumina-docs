...
These Guidelines apply to all user activity on the Service, including but not limited to:

- World creation and publishing
- Character creation and configuration
- Chat sessions with AI characters
- Multiplayer Rooms (creating, hosting, and participating)
- User profiles, display names, and avatars
- Comments, ratings, and reviews
- Reports and communications with other users or Yumina staff
...
- Mild conflict, combat, and action (without graphic depictions of gore or viscera)
...
- Sexual innuendo, fetish content, or sexually suggestive scenarios
...
- If your content contains elements from multiple rating tiers, apply the highest applicable rating
...
- Any sexual or sexually suggestive content depicting, describing, or involving minors (persons under 18)
- Sexual content involving characters who are canonically minors, even if the content describes them as "aged up" to 18 or older
- Sexual content involving characters whose age is ambiguous and who could reasonably be interpreted as minors. Indicators of minor status include but are not limited to: stated age under 18, school uniforms or school settings, descriptions such as "looks young," "childlike," or "petite" when combined with sexual context, or visual depictions with childlike proportions
...
- Recruitment, transportation, or harboring of persons for exploitation
- Commercial sexual exploitation
- Forced labor or servitude
- Content designed to normalize or trivialize trafficking or exploitation
...
- Hacking, unauthorized access to computer systems, or distribution of exploits
...
- Slurs, dehumanizing language, or derogatory stereotypes directed at protected groups
- Glorification of historical atrocities, genocide, or ethnic cleansing
- Calls for violence, exclusion, or discrimination against protected groups
- Propaganda for hate groups or extremist ideologies
- Content designed to recruit for hate movements
...
- False information that is likely to incite or contribute to real-world violence
- False information designed to interfere with political processes, including elections, referendums, or civic participation
- Fabricated claims presented as fact that pose a credible risk of real-world harm
...
- Aggressive, targeted insults or personal attacks against other users
- Threats of any kind, including threats of violence, threats to expose personal information, or threats to damage reputation
- Stalking, including persistent unwanted contact, monitoring, or following a user across the platform after being asked to stop
- Doxxing (publishing another person's private information without their consent)
...
- Graphic, gratuitous depictions of real-world violence intended to shock, glorify, or promote violence are prohibited
...
- Content that promotes, encourages, glorifies, or provides instructions for suicide
- Content that promotes, encourages, or provides instructions for self-mutilation or self-injury
- Content that promotes or glorifies eating disorders or dangerous dietary practices
- Content that promotes or glorifies substance abuse or addiction

Fictional works that address these topics in a thoughtful, narrative context (e.g., a character struggling with and seeking help for mental health issues) are permitted, provided the content does not serve as promotion or instruction.
...
- Real names (when shared against the person's wishes)
...
- Do not engage in mass solicitation or chain messaging
...
- Pyramid schemes, Ponzi schemes, or multi-level marketing solicitations
- Cryptocurrency fraud, pump-and-dump schemes, or unauthorized investment solicitations
...
- Do not create multiple accounts to evade bans, circumvent restrictions, or manipulate the platform
...
- Writing prompts that explicitly request prohibited content
...
- You are not held responsible for genuinely unintentional AI output
- You should report the incident so that Yumina can review and adjust content filters
...
- Prompt injection attacks designed to override system instructions
- Techniques intended to "jailbreak" the AI into ignoring safety guidelines
...
- Text you type directly
- Text generated by AI in response to your prompts
...
- The user's prior history of violations
- The potential harm caused by the violation
...
- Human trafficking or sexual exploitation content
