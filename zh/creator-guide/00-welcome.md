...
**第一次做世界？** 先看 [核心概念](./01-core-concepts.md)——5 分钟看完 Yumina 的整体框架（7 个概念而已）。然后跟着 [编辑器导览](./01-beginner-guide.md) 认识每个面板在哪里，再按 [手把手教程](./02-tutorial-basic.md) 做一个完整世界出来，做完你就出师了 ∠( ᐛ 」∠)＿
