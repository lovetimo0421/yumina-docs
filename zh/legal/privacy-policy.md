...
- Multiplayer rooms;
- The Creator Rewards Program; and
- Any other features, tools, or services we offer.
...
Information that identifies your account and person, including:
...
### 5.2 Device and Network Data

Technical information collected when you access the Service, including:
...
Content you create, upload, or generate through the Service, including:

- Worlds (including characters, settings, variables, rules, game components, and first messages)
- Chat messages exchanged during AI interactive fiction sessions
- Uploaded images, avatars, and other media files
- Multiplayer room configurations and in-room interactions
- Comments, ratings, and other social interactions
- AI-extracted narrative summaries ("World Memories") automatically generated from your chat sessions, categorized by type (event, relationship, fact, decision, item, location, agreement, world state) and scored by narrative importance
- Session checkpoints (snapshots of chat history and game state at specific points)
- AI-assisted world-building conversations and proposals ("Studio" sessions)
- Custom prompt templates and presets

### 5.4 Social and Engagement Data

Data generated through your interactions with the community, including:

- Follow relationships (who you follow and who follows you)
- Favorites (Worlds you have bookmarked)
- Library metadata (Worlds in your library, last played time, update tracking)
- Notifications and their read status
- Achievement and milestone records

"User Content" as used in this Policy refers collectively to all content you create or upload to the Service.

### 5.5 Transaction Data

Records related to your financial transactions on the Service, including:

- Subscription status and plan details
- Purchase history
- Creator Rewards Program earnings and payout records
- Tip and payment transaction records (amounts, dates, payer/payee associations)

### 5.6 Creator Tax and Payout Data

If you participate in the Creator Rewards Program, additional information is collected through Stripe Connect for payment and tax compliance purposes, including:

- Legal name (individual or business entity name)
- Address (residential or business)
- Tax identification information: Social Security Number (SSN) or Employer Identification Number (EIN) for U.S.-based Creators; equivalent tax identifiers for non-U.S. Creators
- IRS Form W-8 data (W-8BEN or W-8BEN-E) for non-U.S. Creators, including country of tax residence and tax treaty claims
- Bank account or debit card details for payout purposes
...
Media you upload to the Service, including:

- Profile avatars
- Character images and artwork
- Other images or visual assets associated with your Worlds

### 5.9 Age Verification Data
...
If you register or sign in using a third-party authentication provider (Google, Discord, or X), we receive certain information from that provider as authorized by you during the OAuth process. This may include:

- Your name or display name on the third-party service
- Email address associated with your third-party account
- Profile picture or avatar
- Unique account identifier from the third-party service
...
When you access or use the Service, we automatically collect certain information through cookies, server logs, and similar technologies, including:
...
Please see Section 10 (Cookies and Similar Technologies) for more information.

### 6.3 Data from Third-Party Login Providers
...
- Displaying your published Worlds and content to other users in accordance with your settings
- Processing AI chat interactions (sending your messages to third-party AI service providers and returning generated responses)
- Facilitating multiplayer rooms and real-time interactions
- Processing transactions, subscriptions, and Creator rewards payouts
...
- Monitoring for violations of our terms of service and community guidelines
- Reviewing reported content and user behavior
- Protecting the safety of our users and the integrity of the Service

### 7.4 Security and Fraud Prevention

- Detecting, investigating, and preventing unauthorized access, fraud, and other malicious activity
- Protecting the security and integrity of the Service and its infrastructure
- Verifying user identity when necessary

### 7.5 Analytics

- Analyzing aggregate, non-individually-identifiable usage data to understand how the Service is used
- Identifying trends and areas for improvement
- Measuring the performance and reliability of the Service

We use aggregate analytics -- not individual-level tracking -- to improve the Service.

### 7.6 Communications

- Sending service-related notifications (e.g., account verification, security alerts, system updates)
- Sending marketing or promotional communications (with your consent where required, and always with the ability to opt out)
...
This section explains how your data is handled when you use the AI chat features of the Service.
...
Yumina does not use your chat messages, World content, or any other User Content to train, fine-tune, or improve any AI model. Your content is used solely to provide the Service to you.
...
When you publish a World, the content you designate as public (including the World's title, description, characters, tags, and associated images) becomes visible to other users of the Service in accordance with your publication settings. Your username and display name are associated with your published Worlds. Unpublished Worlds and private content are not shared with other users.
...
- Protect the rights, property, or safety of Yumina, our users, or the public
- Detect, prevent, or address fraud, security issues, or technical problems

### 9.4 Corporate Events

In the event of a merger, acquisition, reorganization, bankruptcy, asset sale, or similar corporate transaction, your Personal Information may be transferred to the acquiring or successor entity. We will provide notice before your Personal Information is transferred and becomes subject to a different privacy policy.
...
Cookies are small text files placed on your device by a website. They are widely used to make websites work efficiently and to provide information to the operators of the site. We may also use similar technologies such as local storage and session storage.
...
Notwithstanding the above, we may retain certain Personal Information for longer periods where required or permitted by applicable law, including for:
...
You have the right to request a copy of the Personal Information we hold about you. You can view much of your Personal Information directly through your account settings.
...
You have the right to request deletion of your Personal Information. You can delete your account through your account settings, and your data will be deleted within 7 days. Certain data may be retained as described in Section 12.3.

### 14.4 Right to Export

You have the right to export your data in a portable format. Yumina provides the ability to export your Worlds and chat history through the Service.

### 14.5 Right to Withdraw Consent

Where we rely on your consent to process Personal Information, you have the right to withdraw that consent at any time. Withdrawing consent does not affect the lawfulness of processing that occurred before the withdrawal. Please note that if your consent is necessary for the provision of the Service, withdrawing consent may require you to close your account.

### 14.6 Marketing Opt-Out

You can opt out of receiving marketing and promotional communications from us by:
...
### 14.7 Cookie Controls

You can manage cookies through your browser settings as described in Section 10.3.
...
We will not discriminate against you for exercising any of your privacy rights under the CCPA/CPRA. We will not:

- Deny you the Service
- Charge you different prices or rates
- Provide you a different level or quality of service
- Suggest any of the above will occur as a result of exercising your rights

### 15.5 Other U.S. State Privacy Rights

Residents of Virginia (VCDPA), Colorado (CPA), Connecticut (CTDPA), Utah (UCPA), Nevada (NRS Chapter 603A), and other states with consumer data privacy laws may have rights similar to those described above, including the right to access, correct, delete, and opt out of the sale of certain personal information. We do not sell your Personal Information under any state law definition.
...
If you are located in the European Economic Area ("EEA"), the United Kingdom ("UK"), or Switzerland, the following additional provisions apply to you under the General Data Protection Regulation ("GDPR"), the UK GDPR, and the Swiss Federal Act on Data Protection ("FADP"), respectively.
...
The Service may contain links to third-party websites, applications, or services that are not operated or controlled by Yumina. This includes, but is not limited to, third-party authentication providers (Google, Discord, X) and external websites linked from User Content.
